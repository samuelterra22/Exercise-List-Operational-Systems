...
/******************************************************************************
 * Fazer um programa que receba uma lista de nomes de usuário de um SO
 * juntamente com seu identificador uid. Uma lista encadeada ordernada por uid
 * deve ser criada para guardar essas informações. Após isso, uma lista de
 * processos juntamente com o id do usuário que o criou é entrada pelo
 * usuário. Dentro de cada nó da lista de nomes de usuário, deve ser armazenado
 * o ponteiro de início de uma outra lista, a lista de processos do respectivo
 * usuário. No final deve ser apresentado cada usuário, seu id e a lista de
 * processos que estão executando com seu uid.
 *****************************************************************************/
